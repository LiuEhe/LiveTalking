...
The backend codebase must strictly follow a three-layer architecture to ensure decoupling and maintainability.
- **API Layer (`api/`)**: Responsible for defining routes, handling HTTP/WebSocket requests, and performing parameter validation. No business logic should reside here.
